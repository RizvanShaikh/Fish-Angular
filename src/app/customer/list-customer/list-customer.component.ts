...
import { ICustomer } from 'src/app/_shared/interfaces/customer';
...
export class ListCustomerComponent implements OnInit {
  ...
  pageName = 'customer'
  changeStatusUrl : string = 'customer'
  deleteUrl : string = 'customer' ;

  objectList : Array<ICustomer> = [];
  ...
  getObjectList(){
    ...
    this._customerService.getCustomerList(this.params).subscribe(
      (response)=>{
